        ...
        <nav class="msite_nav">
          <div class="swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide" v-for="(cate,index) in newCategory" :key="index">
                <a href="javascript:" class="link_to_food" v-for="(cateItem,index) in cate" :key="index">
                  <div class="food_container">
                    <img :src="`https://fuss10.elemecdn.com/${cateItem.image_url}`">
                  </div>
